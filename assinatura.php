        ...
        <div class="navbar-brand">Escocar</div>
          <div class="navbar-collapse" style="margin-left: 1rem !important; font-size: 1.2rem;">
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="assinatura.php">Assinatura <span class="sr-only"></span></a>
              </li>
            </ul>
          </div>

          <a href="http://127.0.0.1/site/user-auth.php" style="text-decoration: none;"><div class="user-icon user-i" onclick="redirecionar('user-auth.php')"><span class="material-symbols-outlined">
            person
          </span></div></a>
        </nav>
    </header>
